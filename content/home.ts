...
<img alt="Recovery operative assisting a stranded motorist on a UK motorway hard shoulder in daylight" class="w-full h-full object-cover object-center filter brightness-[0.45] contrast-125 scale-105 transform duration-1000" src="/hero-motorway-assistance.webp" width="1200" height="675" loading="eager" decoding="async" fetchpriority="high"/>
...
<img alt="Heavy tilt tray recovery truck loading a car in daylight on a UK highway" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/tilt-tray-recovery-daylight.webp" width="520" height="390" loading="lazy" decoding="async"/>
</div>
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="Recovery technician running roadside diagnostics on a broken-down car in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/breakdown-roadside-operator.webp" width="520" height="390" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="Tilt and slide flatbed recovery truck securing a vehicle with soft wheel straps in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/flatbed-soft-strap-recovery.webp" width="520" height="390" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="Recovery truck assisting a motorist on a UK motorway hard shoulder in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/motorway-hard-shoulder-assist.webp" width="560" height="315" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="The Road Rescue Guys telematics dispatch command centre with live fleet tracking" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/command-centre-dispatch-sm.webp" width="520" height="390" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="The Road Rescue Guys depot yard with a fleet of recovery trucks in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/depot-fleet-daylight-sm.webp" width="520" height="292" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="Tow truck transporting a vehicle along a UK motorway in clear daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/tow-truck-motorway-transport.webp" width="520" height="292" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<article class="flex flex-col rounded-2xl bg-surface-container-low/75 backdrop-blur-2xl shadow-xl overflow-hidden group transition-all duration-300 hover:shadow-2xl">
<div class="relative w-full h-52 overflow-hidden">
<img alt="Recovery truck winching an electric vehicle onto a flatbed in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/ev-winch-recovery-daylight.webp" width="560" height="420" loading="lazy" decoding="async"/>
</div>
<div class="p-space-lg flex flex-col gap-space-sm flex-1">
...
<img alt="Recovery technician securing a car's wheel with soft tie-down straps on a flatbed truck in daylight" class="w-full h-full object-cover" src="/why-choose-us-damage-free.webp" width="1120" height="1400" loading="lazy" decoding="async"/>
...
<img alt="Recovery technicians in high-visibility gear placing safety cones beside vehicles on a UK motorway in daylight" class="w-full h-full object-cover" src="/cinematic-high-vis-protocol.webp" width="560" height="486" loading="lazy" decoding="async"/>
...
<img alt="Recovery truck arriving at a breakdown scene on a UK motorway in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/gallery-motorway-deployment.webp" width="536" height="486" loading="lazy" decoding="async"/>
...
<img alt="Close-up of a hydraulic winch cable loading a car onto a recovery truck in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/gallery-winch-loading.webp" width="755" height="446" loading="lazy" decoding="async"/>
...
<div class="rounded-3xl overflow-hidden shadow-2xl relative h-[180px] group">
<img alt="Recovery truck transporting a car along a UK motorway in daylight" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="/gallery-long-distance-relocation.webp" width="763" height="446" loading="lazy" decoding="async"/>
<div class="absolute inset-0 bg-gradient-to-t from-surface-container-lowest/80 to-transparent"></div>
<div class="absolute bottom-4 left-4">
